...
Взлом будет происходит внутри DosBox, для взлома будет использоваться встроенный дебаггер - turbo debugger. 
...
Посмотрим на дизассимилированный код программы через turbo debugger. Будем пропускать команды, пока командна не попросит ввести очередной символ.
